...
func (nc *NotificationCreate) SetRelatedUserID(s string) *NotificationCreate {
	nc.mutation.SetRelatedUserID(s)
	return nc
}

// SetNillableRelatedUserID sets the "related_user_id" field if the given value is not nil.
func (nc *NotificationCreate) SetNillableRelatedUserID(s *string) *NotificationCreate {
	if s != nil {
		nc.SetRelatedUserID(*s)
	}
	return nc
}

// SetRelatedConversationID sets the "related_conversation_id" field.
func (nc *NotificationCreate) SetRelatedConversationID(s string) *NotificationCreate {
	nc.mutation.SetRelatedConversationID(s)
	return nc
}

// SetNillableRelatedConversationID sets the "related_conversation_id" field if the given value is not nil.
func (nc *NotificationCreate) SetNillableRelatedConversationID(s *string) *NotificationCreate {
	if s != nil {
		nc.SetRelatedConversationID(*s)
	}
	return nc
}
...
func (nc *NotificationCreate) SetRelatedUser(u *User) *NotificationCreate {
	return nc.SetRelatedUserID(u.ID)
}

// SetRelatedConversation sets the "related_conversation" edge to the Conversation entity.
func (nc *NotificationCreate) SetRelatedConversation(c *Conversation) *NotificationCreate {
	return nc.SetRelatedConversationID(c.ID)
}
...
func (nc *NotificationCreate) createSpec() (*Notification, *sqlgraph.CreateSpec) {
	...
	if nodes := nc.mutation.RelatedUserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
		...
		_node.RelatedUserID = nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := nc.mutation.RelatedConversationIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
		...
		_node.RelatedConversationID = nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
