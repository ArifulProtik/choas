...
func (mc *MessageCreate) SetConversationID(s string) *MessageCreate {
	mc.mutation.SetConversationID(s)
	return mc
}
...
func (mc *MessageCreate) SetNillableMessageType(mt *message.MessageType) *MessageCreate {
	if mt != nil {
...
func (mc *MessageCreate) SetIsDeleted(b bool) *MessageCreate {
	mc.mutation.SetIsDeleted(b)
	return mc
}

// SetNillableIsDeleted sets the "is_deleted" field if the given value is not nil.
func (mc *MessageCreate) SetNillableIsDeleted(b *bool) *MessageCreate {
	if b != nil {
		mc.SetIsDeleted(*b)
	}
	return mc
...
func (mc *MessageCreate) check() error {
	...
	if v, ok := mc.mutation.ConversationID(); ok {
