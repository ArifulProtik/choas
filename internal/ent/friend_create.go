...
func (fc *FriendCreate) SetRequesterID(s string) *FriendCreate {
	fc.mutation.SetRequesterID(s)
	return fc
}

// SetAddresseeID sets the "addressee_id" field.
func (fc *FriendCreate) SetAddresseeID(s string) *FriendCreate {
	fc.mutation.SetAddresseeID(s)
	return fc
}
...
func (fc *FriendCreate) SetID(s string) *FriendCreate {
	fc.mutation.SetID(s)
	return fc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (fc *FriendCreate) SetNillableID(s *string) *FriendCreate {
	if s != nil {
		fc.SetID(*s)
	}
	return fc
...
func (fc *FriendCreate) SetAddressee(u *User) *FriendCreate {
	return fc.SetAddresseeID(u.ID)
}
...
func (fc *FriendCreate) check() error {
	...
	if v, ok := fc.mutation.RequesterID(); ok {
	...
	if _, ok := fc.mutation.AddresseeID(); !ok {
		return &ValidationError{Name: "addressee_id", err: errors.New(`ent: missing required field "Friend.addressee_id"`)}
	}
	if v, ok := fc.mutation.AddresseeID(); ok {
	...
	if len(fc.mutation.RequesterIDs()) == 0 {
		return &ValidationError{Name: "requester", err: errors.New(`ent: missing required edge "Friend.requester"`)}
	}
	if len(fc.mutation.AddresseeIDs()) == 0 {
		return &ValidationError{Name: "addressee", err: errors.New(`ent: missing required edge "Friend.addressee"`)}
	}
	return nil
}
...
func (fc *FriendCreate) sqlSave(ctx context.Context) (*Friend, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected Friend.ID type: %T", _spec.ID.Value)
		}
	}
...
func (fc *FriendCreate) createSpec() (*Friend, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(friend.Table, sqlgraph.NewFieldSpec(friend.FieldID, field.TypeString))
	)
	...
	if nodes := fc.mutation.AddresseeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
