...
func (fu *FriendUpdate) SetRequesterID(s string) *FriendUpdate {
	fu.mutation.SetRequesterID(s)
	return fu
}

// SetNillableRequesterID sets the "requester_id" field if the given value is not nil.
func (fu *FriendUpdate) SetNillableRequesterID(s *string) *FriendUpdate {
	if s != nil {
		fu.SetRequesterID(*s)
	}
	return fu
...
func (fu *FriendUpdate) SetAddresseeID(s string) *FriendUpdate {
	fu.mutation.SetAddresseeID(s)
	return fu
}

// SetNillableAddresseeID sets the "addressee_id" field if the given value is not nil.
func (fu *FriendUpdate) SetNillableAddresseeID(s *string) *FriendUpdate {
	if s != nil {
		fu.SetAddresseeID(*s)
	}
	return fu
...
// SetAddressee sets the "addressee" edge to the User entity.
func (fu *FriendUpdate) SetAddressee(u *User) *FriendUpdate {
	return fu.SetAddresseeID(u.ID)
}
...
func (fu *FriendUpdate) ClearAddressee() *FriendUpdate {
	fu.mutation.ClearAddressee()
	return fu
}
...
func (fu *FriendUpdate) check() error {
	if v, ok := fu.mutation.RequesterID(); ok {
		if err := friend.RequesterIDValidator(v); err != nil {
			return &ValidationError{Name: "requester_id", err: fmt.Errorf(`ent: validator failed for field "Friend.requester_id": %w`, err)}
		}
	}
	if v, ok := fu.mutation.AddresseeID(); ok {
		if err := friend.AddresseeIDValidator(v); err != nil {
			return &ValidationError{Name: "addressee_id", err: fmt.Errorf(`ent: validator failed for field "Friend.addressee_id": %w`, err)}
		}
	}
	...
	if fu.mutation.RequesterCleared() && len(fu.mutation.RequesterIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Friend.requester"`)
	}
	if fu.mutation.AddresseeCleared() && len(fu.mutation.AddresseeIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Friend.addressee"`)
	}
	return nil
}
...
func (fu *FriendUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(friend.Table, friend.Columns, sqlgraph.NewFieldSpec(friend.FieldID, field.TypeString))
	...
	if fu.mutation.AddresseeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   friend.AddresseeTable,
			Columns: []string{friend.AddresseeColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(user.FieldID, field.TypeString),
			},
	...
	if nodes := fu.mutation.AddresseeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   friend.AddresseeTable,
...
// SetRequesterID sets the "requester_id" field.
func (fuo *FriendUpdateOne) SetRequesterID(s string) *FriendUpdateOne {
	fuo.mutation.SetRequesterID(s)
	return fuo
}

// SetNillableRequesterID sets the "requester_id" field if the given value is not nil.
func (fuo *FriendUpdateOne) SetNillableRequesterID(s *string) *FriendUpdateOne {
	if s != nil {
		fuo.SetRequesterID(*s)
	}
	return fuo
}

// SetAddresseeID sets the "addressee_id" field.
func (fuo *FriendUpdateOne) SetAddresseeID(s string) *FriendUpdateOne {
	fuo.mutation.SetAddresseeID(s)
	return fuo
}

// SetNillableAddresseeID sets the "addressee_id" field if the given value is not nil.
func (fuo *FriendUpdateOne) SetNillableAddresseeID(s *string) *FriendUpdateOne {
	if s != nil {
		fuo.SetAddresseeID(*s)
	}
	return fuo
}
...
// SetAddressee sets the "addressee" edge to the User entity.
func (fuo *FriendUpdateOne) SetAddressee(u *User) *FriendUpdateOne {
	return fuo.SetAddresseeID(u.ID)
}
...
// ClearAddressee clears the "addressee" edge to the User entity.
func (fuo *FriendUpdateOne) ClearAddressee() *FriendUpdateOne {
	fuo.mutation.ClearAddressee()
	return fuo
}
...
func (fuo *FriendUpdateOne) check() error {
	if v, ok := fuo.mutation.RequesterID(); ok {
		if err := friend.RequesterIDValidator(v); err != nil {
			return &ValidationError{Name: "requester_id", err: fmt.Errorf(`ent: validator failed for field "Friend.requester_id": %w`, err)}
		}
	}
	if v, ok := fuo.mutation.AddresseeID(); ok {
		if err := friend.AddresseeIDValidator(v); err != nil {
			return &ValidationError{Name: "addressee_id", err: fmt.Errorf(`ent: validator failed for field "Friend.addressee_id": %w`, err)}
		}
	}
	...
	if fuo.mutation.RequesterCleared() && len(fuo.mutation.RequesterIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Friend.requester"`)
	}
	if fuo.mutation.AddresseeCleared() && len(fuo.mutation.AddresseeIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Friend.addressee"`)
	}
	return nil
}
...
func (fuo *FriendUpdateOne) sqlSave(ctx context.Context) (_node *Friend, err error) {
	...
	if fuo.mutation.AddresseeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   friend.AddresseeTable,
	...
	if nodes := fuo.mutation.AddresseeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   friend.AddresseeTable,
