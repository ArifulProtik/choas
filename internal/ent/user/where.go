...
// AvaterURL applies equality check predicate on the "avater_url" field. It's identical to AvaterURLEQ.
func AvaterURL(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldAvaterURL, v))
}
...
// AvaterURLEQ applies the EQ predicate on the "avater_url" field.
func AvaterURLEQ(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldAvaterURL, v))
}

// AvaterURLNEQ applies the NEQ predicate on the "avater_url" field.
func AvaterURLNEQ(v string) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldAvaterURL, v))
}

// AvaterURLIn applies the In predicate on the "avater_url" field.
func AvaterURLIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldIn(FieldAvaterURL, vs...))
}

// AvaterURLNotIn applies the NotIn predicate on the "avater_url" field.
func AvaterURLNotIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldAvaterURL, vs...))
}

// AvaterURLGT applies the GT predicate on the "avater_url" field.
func AvaterURLGT(v string) predicate.User {
	return predicate.User(sql.FieldGT(FieldAvaterURL, v))
}

// AvaterURLGTE applies the GTE predicate on the "avater_url" field.
func AvaterURLGTE(v string) predicate.User {
	return predicate.User(sql.FieldGTE(FieldAvaterURL, v))
}

// AvaterURLLT applies the LT predicate on the "avater_url" field.
func AvaterURLLT(v string) predicate.User {
	return predicate.User(sql.FieldLT(FieldAvaterURL, v))
}

// AvaterURLLTE applies the LTE predicate on the "avater_url" field.
func AvaterURLLTE(v string) predicate.User {
	return predicate.User(sql.FieldLTE(FieldAvaterURL, v))
}

// AvaterURLContains applies the Contains predicate on the "avater_url" field.
func AvaterURLContains(v string) predicate.User {
	return predicate.User(sql.FieldContains(FieldAvaterURL, v))
}

// AvaterURLHasPrefix applies the HasPrefix predicate on the "avater_url" field.
func AvaterURLHasPrefix(v string) predicate.User {
	return predicate.User(sql.FieldHasPrefix(FieldAvaterURL, v))
}

// AvaterURLHasSuffix applies the HasSuffix predicate on the "avater_url" field.
func AvaterURLHasSuffix(v string) predicate.User {
	return predicate.User(sql.FieldHasSuffix(FieldAvaterURL, v))
}

// AvaterURLIsNil applies the IsNil predicate on the "avater_url" field.
func AvaterURLIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldAvaterURL))
}

// AvaterURLNotNil applies the NotNil predicate on the "avater_url" field.
func AvaterURLNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldAvaterURL))
}

// AvaterURLEqualFold applies the EqualFold predicate on the "avater_url" field.
func AvaterURLEqualFold(v string) predicate.User {
	return predicate.User(sql.FieldEqualFold(FieldAvaterURL, v))
}

// AvaterURLContainsFold applies the ContainsFold predicate on the "avater_url" field.
func AvaterURLContainsFold(v string) predicate.User {
	return predicate.User(sql.FieldContainsFold(FieldAvaterURL, v))
}
...
// HasOwnedGuilds applies the HasEdge predicate on the "owned_guilds" edge.
func HasOwnedGuilds() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasOwnedGuildsWith applies the HasEdge predicate on the "owned_guilds" edge with a given conditions (other predicates).
func HasOwnedGuildsWith(preds ...predicate.Guild) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newOwnedGuildsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasMemberOf applies the HasEdge predicate on the "member_of" edge.
...
// HasMemberOfWith applies the HasEdge predicate on the "member_of" edge with a given conditions (other predicates).
func HasMemberOfWith(preds ...predicate.Member) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasFriendRequestsSent applies the HasEdge predicate on the "friend_requests_sent" edge.
func HasFriendRequestsSent() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasFriendRequestsSentWith applies the HasEdge predicate on the "friend_requests_sent" edge with a given conditions (other predicates).
func HasFriendRequestsSentWith(preds ...predicate.Friend) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newFriendRequestsSentStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasFriendRequestsReceived applies the HasEdge predicate on the "friend_requests_received" edge.
func HasFriendRequestsReceived() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasFriendRequestsReceivedWith applies the HasEdge predicate on the "friend_requests_received" edge with a given conditions (other predicates).
func HasFriendRequestsReceivedWith(preds ...predicate.Friend) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newFriendRequestsReceivedStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasRelatedNotifications applies the HasEdge predicate on the "related_notifications" edge.
func HasRelatedNotifications() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasRelatedNotificationsWith applies the HasEdge predicate on the "related_notifications" edge with a given conditions (other predicates).
func HasRelatedNotificationsWith(preds ...predicate.Notification) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newRelatedNotificationsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasConversationParticipations applies the HasEdge predicate on the "conversation_participations" edge.
func HasConversationParticipations() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasConversationParticipationsWith applies the HasEdge predicate on the "conversation_participations" edge with a given conditions (other predicates).
func HasConversationParticipationsWith(preds ...predicate.ConversationParticipant) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newConversationParticipationsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasBlockedUsers() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBlockedUsersWith(preds ...predicate.Block) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasBlockedByUsers applies the HasEdge predicate on the "blocked_by_users" edge.
func HasBlockedByUsers() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasBlockedByUsersWith applies the HasEdge predicate on the "blocked_by_users" edge with a given conditions (other predicates).
func HasBlockedByUsersWith(preds ...predicate.Block) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newBlockedByUsersStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
